...
struct Color {
	...
	// Accesses color component by index [0, 2].
	// @param[in] idx: The index of the color to get.
	// @return: The color component mapped as [0, 1, 2] -> [R, G, B]
	float& operator[]( const int );

	// Accesses color component by index [0, 2] (const).
	// @param[in] idx: The index of the color to get.
	// @return: The color component mapped as [0, 1, 2] -> [R, G, B]
